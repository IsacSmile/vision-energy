...
function ItemCardOrRow({
    ...
    return (
      <Reveal staggerIndex={staggerIndex} as="article">
        <div className="px-4 sm:px-6 py-5 border-b border-[#1F2937] last:border-b-0">
          {/* Mobile View (below lg): Grid layout [40px icon] [content] */}
          <div className="lg:hidden group/card relative flex items-start gap-4 min-h-[88px] cursor-pointer">
            {/* Group Icon Box (40px) */}
            <div className="w-10 h-10 rounded-lg bg-[#0B65B3]/15 border border-[#0B65B3]/30 text-[#8DC63F] flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="flex-1 min-w-0 space-y-1.5">
              ...
              {/* Enquire Now Button (44px tall, auto-width, 16px gap mt-4) */}
              <div className="pt-2">
                <EnquireNowButton
                  cat={cat}
                  openModal={openModal}
          ...
          {/* Desktop List View (lg and up): Grid [40px icon] [content] [button] */}
          <div className="hidden lg:flex group/card relative items-center gap-6 py-2 cursor-pointer">
            {/* Group Icon Box (40px) */}
            <div className="w-10 h-10 rounded-lg bg-[#0B65B3]/15 border border-[#0B65B3]/30 text-[#8DC63F] flex items-center justify-center shrink-0">
              <GroupIcon className="w-5 h-5" />
            </div>
  ...
  return (
    <Reveal staggerIndex={staggerIndex} as="article" className="h-full">
      <div className="relative group/card bg-[#0D1117] border border-[#1F2937] hover:border-[#0B65B3]/50 hover:bg-[#161B22]/50 rounded-2xl p-5 sm:p-6 flex flex-col h-full transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(11,101,179,0.12)] active-press cursor-pointer">
        {/* Card Top Row: Group Icon (40px) + Code & ArrowUpRight */}
        <div className="flex items-center justify-between gap-2 mb-4">
          <div className="w-10 h-10 rounded-lg bg-[#0B65B3]/15 border border-[#0B65B3]/30 text-[#8DC63F] flex items-center justify-center shrink-0">
            <GroupIcon className="w-5 h-5" />
          </div>
          <div className="flex items-center gap-2 shrink-0">
            <span className="text-xs font-semibold text-[#A9B4C0] tabular-nums">
        ...
        <div className="space-y-2.5 mb-5 flex-1">
          ...
          <p className="text-xs sm:text-sm text-[#A9B4C0] line-clamp-3 leading-relaxed">
            {cat.description}
          </p>
        ...
        <div className="pt-5 border-t border-[#1F2937] mt-auto">
          <EnquireNowButton
            cat={cat}
            openModal={openModal}
