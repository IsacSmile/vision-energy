    ...
    >
      <div className="h-[56px] px-3 flex items-center gap-2 max-w-lg mx-auto">
        <a
          ...
          className="flex-1 h-11 flex items-center justify-center gap-2 rounded-xl bg-white text-[#050608] font-bold text-sm active:bg-gray-200 transition-colors shadow-md"
        >
        ...
        <button
          ...
          className="flex-1 h-11 flex items-center justify-center gap-2 rounded-xl bg-gradient-brand text-white font-bold text-sm active:opacity-90 transition-opacity shadow-md"
        >
          {isServicePage ? (
            <>
